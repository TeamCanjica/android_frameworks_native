...
bool GLConsumer::stillTracking(int slot,
    ...
    // For NovaThor check if the buffer should not be the case for BlitSlot
    // This should fix random reboots because stillTracking method will operate as it should.
